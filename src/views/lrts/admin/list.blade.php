                    ...
                    @if (is_array($nodes))
                        @foreach($nodes as $node)
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-primary event-lrts-add">添加子节点</button>
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="lrts-add-modal-node-name" placeholder="请输入节点名称">
                        </div>
                    </div>
                </form>
            </div>
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form">
                    <div class="form-group">
                        <label for="inputEmail3" class="col-sm-2 control-label">节点名称</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="lrts-edit-modal-node-name" placeholder="请输入节点名称">
                        </div>
                    </div>
                </form>
            </div>
